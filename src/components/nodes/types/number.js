  ...
  if (props.widget) {
    ...
    return (
      <div className={cn("node", "number")}>
        {props.label && (
          <label htmlFor={props.path} className={cn("nodeNumber", props.name, "label", props.layoutStyle)}>
            {props.label}
            {props.description && (
              <span htmlFor={props.path} className={cn("nodeNumber", props.name, "description", props.layoutStyle)}>{props.description}</span>
            )}
          </label>
        )}
